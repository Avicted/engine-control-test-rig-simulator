...
/*
 * @requirement REQ-ENG-SCRIPT-002
 * @pre engine != NULL, sensor_frames != NULL, tick_count in validated bounds
 * @post profile executes using deterministic HAL framing/decode path only
 * @deterministic yes
 */
